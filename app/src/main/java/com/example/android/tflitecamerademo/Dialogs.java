...
public class Dialogs {
    // Kids
    public Map<String, String> greetings = new HashMap<>();
    ...
    public Dialogs(){
        ...
        greetings.put("female_adult_happiness","女士，你看起來氣色很棒喔!");
        greetings.put("female_adult_neutral","女士，今天心情怎麼樣?");
        greetings.put("female_adult_sadness","女士，你怎麼看起來不開心?");
        greetings.put("female_adult_surprise", "女士，你看起來很驚訝!");

        greetings.put("male_adult_anger","先生，你為什麼看起來很生氣的樣子?");
        ...
        greetings.put("male_senior_anger","先生，您為什麼看起來很生氣的樣子?");
